  ...
  if (overlay) {
    overlay.innerHTML = `
      <div style="text-align:center;padding:20px;font-family:'Inter',sans-serif">
        ...
        <h3 style="color:#f1f5f9;margin-bottom:8px;font-family:'Outfit',sans-serif">Failed to load game</h3>
        <p style="color:#94a3b8;font-size:0.85rem;margin-bottom:16px">${err || 'Unknown error. Some games require a BIOS file.'}</p>
        <a href="index.html" style="padding:8px 20px;background:rgba(139,92,246,0.3);border:1px solid rgba(139,92,246,0.5);color:#a78bfa;border-radius:10px;font-size:0.85rem;text-decoration:none">← Back to Library</a>
      </div>`;
  }
}
